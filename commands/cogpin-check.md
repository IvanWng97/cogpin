---
description: Run the cogpin Definition-of-Done gate and report blocking vs advisory findings.
allowed-tools: Bash(python3 *)
---

Change-layer gate output for the committed range:

!`python3 "${CLAUDE_PLUGIN_ROOT}/cogpin.py" check --cwd "${CLAUDE_PROJECT_DIR:-.}"`

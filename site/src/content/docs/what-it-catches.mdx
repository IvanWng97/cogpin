...
Every check reads only facts — never your code. The {/* gen:count */}26{/* /gen:count */} below; full field reference in
[`SCHEMA.md`](https://github.com/IvanWng97/cogpin/blob/main/SCHEMA.md). This table is generated from the
registry in [`docs/primitives.md`](https://github.com/IvanWng97/cogpin/blob/main/docs/primitives.md).

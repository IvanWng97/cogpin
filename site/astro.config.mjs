...
// Project page → https://ivanwng97.github.io/cogpin/. If a custom domain is added,
// set base to '/' and add a CNAME. The playground fetches the engine via
// import.meta.env.BASE_URL so it resolves under the /cogpin prefix.
export default defineConfig({
  ...
  // `/cogpinwhat-it-catches` (missing the separator). Keep the slash.
  base: '/cogpin/',
  ...
  integrations: [
    starlight({
      ...
      logo: { src: './src/assets/logo.svg', alt: 'cogpin' },
      ...
      favicon: '/favicon.svg',
      social: [{ icon: 'github', label: 'GitHub', href: 'https://github.com/IvanWng97/cogpin' }],
      ...
      sidebar: [
        {
          ...
          items: [
            ...
            { label: 'Where cogpin fits', slug: 'composition' },
          ],
        },
      ],
    }),
